...
export const questionList: questionProps[] = [
  {
    ...
    desc3: "본받고 싶어?",
    placeholder:
      "내 친구랑 같이 있으면 말을 재밌게 해서 정말 즐겁고 시간이 5배속으로 가는 거 같아. 또 별명이 봉무위키였던 적이 있을 정도로 박학다식해. 아는게 정말 많고 세상에 대해 호기심이 많아서 매사에 열심히 사는 친구라서 본받고 싶은 점들이 너무 많다 ~",
    checked: false,
    disabled: false,
  },
  {
  ...
  },
  {
    ...
    desc3: "매력은 뭐라고 생각해?",
    placeholder:
      "내 친구는 하루도 안빼먹고 매일 아침에 헬스하는데, 그 이유가 좋아하는 사람이 생기면 더 당당해지고 싶기 때문이라고 하더라 멋있는 친구야ㅎㅎㅎ 몸도 좋아져서 이번에 바프도 찍었더라~",
    checked: false,
    disabled: false,
  },
  ...
  },
  {
    ...
    desc3: "가장 큰 장점은?",
    placeholder:
      "내가 프로필이나 인스타에 올리는 사진 중 이친구가 찍으면 바로 올라갈 정도로 미적 감각이 엄청난 친구라서 사진찍는거나 예술에 대한 이야기같이하면 좋을거같아 진짜 같이 사진찍는데 주접도 잘 떨고 예쁘게 찍어줘서 나도 배우고 싶을정도ㅋㅋ",
    checked: false,
    disabled: false,
  },
  {
  ...
  },
  {
    ...
    desc3: "자주 대화해?",
    placeholder:
      "내 친구랑 영화 취향이 비슷해서 영화 얘기를 많이 해! 최근에 에.에.올 보고 너무 재밌어서 친구랑 4시간 동안 영화 얘기만 했었어 ㅋㅋㅋ 영화에 완전 진심인 사람을 만나면 재밌을 거 같아!",
    checked: false,
    disabled: false,
  },
  {
    ...
    desc3: "계기가 뭐야?",
    placeholder:
      "상사한테 한 소리듣고 풀죽어 있었던 적이 있었어. 근데 갑자기 얼굴만 알던 직장동기가 와서 힘내라는 쪽지랑 캔커피를 하나 주더라.. 안친한데도 그렇게 친절을 베푼 게 너무 감동이었어. 그래서 내가 친해지고 싶다고 들이대서 친해지게 됐어! ㅎㅎ",
    checked: false,
    disabled: false,
  },
];
